...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 via-purple-600 to-blue-500 text-white">
      {/* Wrap the content in a flex container, but keep the footer outside of the container with max-width */}
      <Navbar />
      <div className="max-w-4xl text-center space-y-10 py-16 mx-auto">
        <motion.h1 
          initial={{ opacity: 0, y: -40 }} 
          animate={{ opacity: 1, y: 0 }} 
          transition={{ duration: 0.8 }}
      ...
      {/* Move Footer outside of max-w-4xl to make it span full width */}
      <Footer />
    </div>
  );
}
